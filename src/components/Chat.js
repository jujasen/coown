    ...
    return (
        ...
        <div className="chat">
            ...
            <div className="chat__box">
                ...
                <div className="chat__bubble chat__bubble--user">
                    <div>
                        ...
                        <p className="chat__text">Jeg trenger mer info om en leilighet</p>
                    </div>
                </div>
            ...
            <div className="chat__data">
                ...
                <img className="chat__send" src={Send} alt="send"/>
            </div>
        </div>
        <img className="chat__toggle" src={Bubble} alt="open chat"/>
        </>
    );
}
